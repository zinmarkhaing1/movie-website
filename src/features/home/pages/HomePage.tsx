...
export default function HomePage() {
  ...
  return (
    ...
    //         Browse handpicked films, trending picks, and classics curated for every mood.
    //       </p>
    //       <div className="cta-row">
    //         <button type="button" className="primary-btn">Watch Now</button>
    //         <button type="button" className="secondary-btn">Browse Movies</button>
    //       </div>
    //     </div>

    //     <div className="featured-card">
    //       <div
    //         className="movie-poster poster-one"
    //         style={{
    //           backgroundImage: `linear-gradient(135deg, rgba(34, 197, 94, 0.3), rgba(59, 130, 246, 0.2)), url(${featuredMovie?.poster ?? ''})`,
    //         }}
    //       />
    //       <div className="movie-meta">
    //         <span className="tag">Featured</span>
    //         <h2>{featuredMovie?.title ?? 'Featured Movie'}</h2>
    //         <p>{featuredMovie?.description ?? 'A cinematic pick for tonight.'}</p>
    //         <Link to={`/movie/${featuredMovie?.id ?? ''}`} className="detail-link">View details</Link>
    //       </div>
    //     </div>
    //   </section>
    ...
    //           <div
    //             className="movie-poster poster-two"
    //             aria-hidden="true"
    //             style={{
    //               backgroundImage: `linear-gradient(135deg, rgba(168, 85, 247, 0.3), rgba(251, 146, 60, 0.25)), url(${movie.poster})`,
    //             }}
    //           />
    ...
    //             </div>
    //             <h4>{movie.title}</h4>
    //             <div className="movie-bottomline">
    //               <span>{movie.year}</span>
    //               <span>{movie.duration}</span>
    //             </div>
    //             <div className="movie-actions">
    //               <Link to={`/movie/${movie.id}`} className="detail-link">Details</Link>
    //               <button type="button" className="favorite-btn" onClick={() => toggleFavorite(movie)}>
